...
##### 
# sim_one_treatment_2 =function(data,j, realG1, realA1, realB1 ,Right_Y_model = TRUE, Right_E_model = TRUE, Right_I_model = TRUE )  {
#   
#   X1 = data$X1
#   X2 = data$X2
#   Y = data$Y
...
#     I2c = I2<=0 
# 
#     n11 = betareg('I~X1+X2',list('I'=rI0, 'X1'=X1[E==j] , 'X2'=X2[E==j] ))
#     
# 
#     n1p = predict.betareg(n11, list('X1'=X1 , 'X2'=X2),type = "response")
#     #n1pall = matrix(n1p,n,n)
#     
#     n1I1 = predict.betareg(n11 ,  list( 'X1'=X1[E==j],'X2'=X2[E==j]),type = "response")
# 
#   
#   
#   rankr1y1 =n1I1 # colMeans(n1pall)[E==j]
#   rankr1ya =n1p # colMeans(n1pall)
#   
#   
#   
#   
